        ...
        <MDBRow>
            <MDBCol md='4'>
                <img
                  ...
                  alt="Avatar-Ahmed"
                />
                <h5 class="mb-2"><strong>Ahmed Tlili</strong> </h5>
            ...
            <MDBCol md='4'>
                <img
                  ...
                  alt="Avatar-Yiping"
                />
                <h5 class="mb-2"><strong>Yiping Wang</strong> </h5>
                <p class="text-muted">Senior Research Assistant & Project Manager</p>
            </MDBCol>
            <MDBCol md='4'>
                <img
                  src={Zhiminimg}
                  ...
                  alt="Avatar-Zhimin"
                />
                <h5 class="mb-2"><strong>Zhimin Li</strong> </h5>
        ...
        <MDBRow>
            <MDBCol md='4'>
                <img
                  ...
                  alt="Avatar-Lulu"
                />
                <h5 class="mb-2"><strong>Jialu Zhao</strong> </h5>
                <p class="text-muted">Research Assistant</p>
            </MDBCol>
            <MDBCol md='4'>
                <img
                  ...
                  alt="Avatar-Rick"
                />
                <h5 class="mb-2"><strong>Rick Young</strong> </h5>
